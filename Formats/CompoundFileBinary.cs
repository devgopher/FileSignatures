...
namespace FileSignatures.Formats
{
    ...
    public abstract class CompoundFileBinary : FileFormat, IFileFormatReader
    {
        ...
        public CompoundFileBinary(string storage, string mediaType, string extension) : base(new byte[] {0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1},
                                                                                             int.MaxValue,
                                                                                             mediaType,
                                                                                             extension)
        {
        ...
        {
            if (file is CompoundFile cf) return cf.RootStorage.TryGetStream(Storage, out var _);
